...
module.exports = msg => {
  ...
  //custom reactions
  var customReactions = [/dftba/i, /thank you ryan/i, /thanks ryan/i, /thank ya ryan/i, /no edge/i, /brain soup/i, /french the llama/i, /mongols/i, /tuatara /i, /all the way down/i];
